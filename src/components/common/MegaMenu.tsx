...
export const MegaMenu: React.FC<MegaMenuProps> = ({ menu, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-50 bg-white dark:bg-gray-900 lg:absolute lg:inset-x-0 lg:top-full lg:z-40 lg:bg-transparent lg:bg-white/80 lg:dark:bg-gray-900/80 lg:backdrop-blur-lg"
    >
      {/* Desktop View */}
      <div className="hidden lg:block absolute inset-x-0 top-0 bg-white dark:bg-gray-900 shadow-lg border-t border-gray-200 dark:border-gray-800">
