...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path d="M12 19a3 3 0 1 0 5.993.129" />
    <path d="M13.2 6.51A3 3 0 0 0 12 5a3 3 0 0 0-1.2.49" />
    <path d="M20.993 14.129A3 3 0 0 0 15 13a3 3 0 0 0-2.348.98" />
    <path d="m9.652 13.98A3 3 0 0 1 12 13a3 3 0 0 1 2.348.98" />
    <path d="M3.007 14.129A3 3 0 0 1 9 13a3 3 0 0 1-1.2.49" />
    <path d="m4.207 7.51-.01.001A3 3 0 0 1 9 5a3 3 0 0 1 1.2.49" />
    <path d="M19.793 7.51A3 3 0 0 0 15 5a3 3 0 0 0-1.2.49" />
    <path d="m4.207 16.49.01-.001A3 3 0 0 0 9 19a3 3 0 0 0 1.2-.49" />
    <path d="m19.793 16.49A3 3 0 0 1 15 19a3 3 0 0 1-1.2-.49" />
  </svg>
);
...
export const CloudCogIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    ...
    <path d="M12 13v1" />
    <path d="M12 20v1" />
    <path d="m14.6 14.6.7.7" />
    <path d="m8.7 18.7.7.7" />
    <path d="M15 17h-1" />
    <path d="M9 17H8" />
    <path d="m14.6 19.4-.7-.7" />
    <path d="m8.7 15.3-.7-.7" />
  </svg>
);
