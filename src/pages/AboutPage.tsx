...
export const AboutPage: React.FC = () => (
  <Section>
    <SectionTitle subtitle="About Us">Our Mission & Team</SectionTitle>
    <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500 dark:text-gray-400">
      We are a team of passionate technologists dedicated to solving complex problems and delivering
      tangible business value through principled engineering and innovative thinking. Our mission is
      to empower organizations with the data and AI capabilities needed to thrive in a digital-first
      world.
    </p>
    <div className="mt-20">
